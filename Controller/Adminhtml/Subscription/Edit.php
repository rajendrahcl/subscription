...
class Edit extends \Hcl\Subscription\Controller\Adminhtml\Subscription
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('hcl_subscription_subscription', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(
            $model->getId() ? __('Edit Subscription %1', $model->getId()) : __('New Subscription')
        );
        return $resultPage;
    }
}
