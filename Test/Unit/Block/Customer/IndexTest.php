<?php
namespace Hcl\Subscription\Test\Unit\Block\Customer;
...
/**
 * @covers \Hcl\Subscription\Block\Customer\Index
 */
class IndexTest extends TestCase
{
     ...
     * Object to test
     *
     * @var \Hcl\Subscription\Block\Customer\Index
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        $this->interface = $this->createMock(\Magento\Framework\ObjectManagerInterface::class);
        $this->testObject = $this->objectManager->getObject(
        \Hcl\Subscription\Block\Customer\Index::class,
            [
     ...
     * @return array
     */
    public function dataProviderForTestGetCustomerEmail()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetCustomerEmail
     */
    public function testGetCustomerEmail(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetSubscriptionData()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetSubscriptionData
     */
    public function testGetSubscriptionData(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetViewUrl()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetViewUrl
     */
    public function testGetViewUrl(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetReorderUrl()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetReorderUrl
     */
    public function testGetReorderUrl(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetProductUrl()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetProductUrl
     */
    public function testGetProductUrl(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
